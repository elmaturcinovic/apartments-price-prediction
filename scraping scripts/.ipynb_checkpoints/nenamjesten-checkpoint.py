...
URL = "https://olx.ba/pretraga?attr=313034284e656e616d6a65c5a174656e293a373031322850726f64616a6129&attr_encoded=1&category_id=23&listing_type=sell&canton=9&cities=&page="
...
number_of_pages = int(result_soup.find("h1", class_="search-title").find("b").text.replace(".", ""))//40 + 1
...
df.to_csv('stanovi_nenamjesteni.csv')
